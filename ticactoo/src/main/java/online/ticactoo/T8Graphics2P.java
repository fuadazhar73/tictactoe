...
import online.ticactoo.T7Graphics2P.DrawCanvas;
import online.ticactoo.T7Graphics2P.GameState;
import online.ticactoo.T7Graphics2P.Seed;

public class T8Graphics2P extends JFrame{
	 ...
	 /** Initialize the game-board contents and the status */
	   ...
	   public boolean hasWon(Seed theSeed, int rowSelected, int colSelected) {
	      return (board[rowSelected][0] == theSeed  // 8-in-the-row
	       ...
	       || board[0][colSelected] == theSeed      // 8-in-the-column
	       ...
	       || rowSelected == colSelected            // 8-in-the-diagonal
	            && board[0][0] == theSeed
	            && board[1][1] == theSeed
	            && board[2][2] == theSeed
	            && board[3][3] == theSeed
	            ...
	            && board[6][6] == theSeed
	            && board[7][7] == theSeed
	       || rowSelected + colSelected == 7  // 8-in-the-opposite-diagonal
	            && board[0][7] == theSeed
	            && board[1][6] == theSeed
	            && board[2][5] == theSeed
	            && board[3][4] == theSeed
