...
import online.ticactoo.T4Graphics2P.DrawCanvas;
import online.ticactoo.T4Graphics2P.GameState;
import online.ticactoo.T4Graphics2P.Seed;

public class T5Graphics2P extends JFrame{
