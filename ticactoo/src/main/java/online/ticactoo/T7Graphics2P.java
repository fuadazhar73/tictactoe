...
import online.ticactoo.T6Graphics2P.DrawCanvas;
import online.ticactoo.T6Graphics2P.GameState;
import online.ticactoo.T6Graphics2P.Seed;

public class T7Graphics2P extends JFrame{
	 ...
	 /** Initialize the game-board contents and the status */
	   ...
	   public boolean hasWon(Seed theSeed, int rowSelected, int colSelected) {
	      return (board[rowSelected][0] == theSeed  // 7-in-the-row
	       ...
	       || board[0][colSelected] == theSeed      // 7-in-the-column
	       ...
	       || rowSelected == colSelected            // 7-in-the-diagonal
	            && board[0][0] == theSeed
	            && board[1][1] == theSeed
	            && board[2][2] == theSeed
	            && board[3][3] == theSeed
	            ...
	            && board[5][5] == theSeed
	            && board[6][6] == theSeed
	       || rowSelected + colSelected == 6  // 7-in-the-opposite-diagonal
	            && board[0][6] == theSeed
	            && board[1][5] == theSeed
	            && board[2][4] == theSeed
	            && board[3][3] == theSeed
