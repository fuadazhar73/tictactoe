...
import online.ticactoo.T5Graphics2P.DrawCanvas;
import online.ticactoo.T5Graphics2P.GameState;
import online.ticactoo.T5Graphics2P.Seed;

public class T6Graphics2P extends JFrame{
